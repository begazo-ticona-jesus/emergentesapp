        ...
        children: [
          ...
          SliderTheme(
            data: SliderThemeData(
              trackHeight: 12.0,
              activeTrackColor: isEnabled ? const Color(0xFFa4acf4) : Colors.grey, // Deshabilitar el color activo cuando no está habilitado
              inactiveTrackColor: Colors.white, // pista inactiva
              thumbColor: isEnabled ? const Color(0xFFa4acf4) : Colors.grey, // Deshabilitar el color de la bolita cuando no está habilitado
